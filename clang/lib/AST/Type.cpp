...
PackIndexingType::PackIndexingType(const ASTContext & Context, QualType Canonical, QualType Pattern, Expr* IndexExpr,
                                   ArrayRef<QualType> Expansions, int Index)
    : Type(PackIndexing, Canonical,
           computeDependence(Pattern, IndexExpr, Expansions)),
      Context(Context), Pattern(Pattern), IndexExpr(IndexExpr), Size(Expansions.size()), Index(Index) {

  std::uninitialized_copy(Expansions.begin(), Expansions.end(), getTrailingObjects<QualType>());
}
...
void PackIndexingType::Profile(llvm::FoldingSetNodeID &ID, const ASTContext &Context,
