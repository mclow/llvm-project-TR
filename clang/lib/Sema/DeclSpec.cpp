...
const char *DeclSpec::getSpecifierName(DeclSpec::TST T,
  ...
  case DeclSpec::TST_indexed_typename_pack: return "type-name-pack-indexing";
...
void DeclSpec::SetPackIndexingExpr(SourceLocation EllipsisLoc, Expr* IndexingExpr) {
  assert(TypeSpecType == TST_typename && "pack indexing can only be applied to typename");
