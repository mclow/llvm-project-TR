...
public:
  ...
  template <class _Tp>
  _LIBCPP_HIDE_FROM_ABI constexpr explicit __output_buffer(_CharT* __ptr, size_t __capacity, _Tp* __obj)
      : __ptr_(__ptr),
        __capacity_(__capacity),
        __flush_([](_CharT* __p, size_t __n, void* __o) { static_cast<_Tp*>(__o)->__flush(__p, __n); }),
        __obj_(__obj) {}

  _LIBCPP_HIDE_FROM_ABI constexpr void __reset(_CharT* __ptr, size_t __capacity) {
    __ptr_ = __ptr;
    __capacity_ = __capacity;
  }

  _LIBCPP_HIDE_FROM_ABI constexpr auto __make_output_iterator() { return std::back_insert_iterator{*this}; }

  // Used in std::back_insert_iterator.
  _LIBCPP_HIDE_FROM_ABI constexpr void push_back(_CharT __c) {
    __ptr_[__size_++] = __c;
  ...
  _LIBCPP_HIDE_FROM_ABI constexpr void __copy(basic_string_view<_InCharT> __str) {
  ...
  _LIBCPP_HIDE_FROM_ABI void constexpr __transform(const _InCharT* __first, const _InCharT* __last, _UnaryOperation __operation) {
  ...
  /// A \c fill_n wrapper.
  _LIBCPP_HIDE_FROM_ABI constexpr void __fill(size_t __n, _CharT __value) {
    __flush_on_overflow(__n);
    if (__n <= __capacity_) {
  ...
  _LIBCPP_HIDE_FROM_ABI constexpr void __flush() {
...
private:
  ...
  _LIBCPP_HIDE_FROM_ABI constexpr void __flush_on_overflow(size_t __n) {
    if (__size_ + __n >= __capacity_)
      __flush();
  }
};
...
public:
  _LIBCPP_HIDE_FROM_ABI constexpr _CharT* __begin() { return __buffer_; }
...
public:
  _LIBCPP_HIDE_FROM_ABI constexpr explicit __writer_direct(_OutIt __out_it)
      : __out_it_(__out_it) {}

  _LIBCPP_HIDE_FROM_ABI constexpr _OutIt __out_it() { return __out_it_; }

  _LIBCPP_HIDE_FROM_ABI constexpr void __flush(_CharT*, size_t __n) {
...
public:
  _LIBCPP_HIDE_FROM_ABI constexpr explicit __writer_iterator(_OutIt __out_it)
      : __out_it_{_VSTD::move(__out_it)} {}

  _LIBCPP_HIDE_FROM_ABI constexpr _OutIt __out_it() && { return std::move(__out_it_); }

  _LIBCPP_HIDE_FROM_ABI constexpr void __flush(_CharT* __ptr, size_t __n) {
...
public:
  ...
  _LIBCPP_HIDE_FROM_ABI constexpr explicit __writer_container(back_insert_iterator<_Container> __out_it)
      : __container_{__out_it.__get_container()} {}

  _LIBCPP_HIDE_FROM_ABI constexpr auto __out_it() { return std::back_inserter(*__container_); }
...
public:
  _LIBCPP_HIDE_FROM_ABI explicit constexpr __format_buffer(_OutIt __out_it)
  ...
  _LIBCPP_HIDE_FROM_ABI explicit constexpr __format_buffer(_OutIt __out_it) requires(
  ...
  _LIBCPP_HIDE_FROM_ABI constexpr auto __make_output_iterator() { return __output_.__make_output_iterator(); }

  _LIBCPP_HIDE_FROM_ABI constexpr void __flush(_CharT* __ptr, size_t __n) { __writer_.__flush(__ptr, __n); }

  _LIBCPP_HIDE_FROM_ABI constexpr _OutIt __out_it() && {
    __output_.__flush();
...
public:
  ...
  _LIBCPP_HIDE_FROM_ABI constexpr void __flush(const _CharT*, size_t __n) { __size_ += __n; }

  _LIBCPP_HIDE_FROM_ABI constexpr size_t __result() && {
    __output_.__flush();
    return __size_;
  }
...
public:
  _LIBCPP_HIDE_FROM_ABI constexpr explicit __format_to_n_buffer_base(_OutIt __out_it, _Size __max_size)
...
public:
  _LIBCPP_HIDE_FROM_ABI constexpr explicit __format_to_n_buffer(_OutIt __out_it, _Size __max_size)
  ...
  _LIBCPP_HIDE_FROM_ABI constexpr format_to_n_result<_OutIt> __result() && {
